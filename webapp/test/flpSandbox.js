		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoices List",
									"targetURL": "#Pruebainvoices-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Pruebainvoices-display": {
								"semanticObject": "Pruebainvoices",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=Prueba.invoices",
									"url": sap.ui.require.toUrl("Prueba/invoices")
								}
							}
						}
					}
